...
directory = pathlib.Path(r"D:\Desktop\Rita\New_new_maps\NF")
...
auto3d_dir = pathlib.Path(r"D:\Desktop\Rita\New_new_maps\Trabecular\Talus_results\aligned\Talus_BO")
...
rotation_dict, vtk_list = get_initial_aligned_dict(auto3dgm_dir=auto3d_dir, csv_list=False)
...
vtp_visualize_deformation(point_cloud_dir=directory, canonical_pc=canonical_point_cloud, outName="canonical_BO_talus")
